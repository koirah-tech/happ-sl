...
export default function DotCard({icon: Icon, title, description, bgStyling, step}: DotCardProps) {
  return (
    <div className="relative mx-auto w-full max-w-sm px-4  sm:px-6 md:px-8">
      ...
      <div className="relative w-full border-x border-zinc-400 dark:border-zinc-700 step-badge" data-step={step}>
        ...
        <div className="relative z-20 mx-auto py-8">
          <div className="p-6">
            <div 
              className={`${bgStyling} relative w-fit p-2 mb-5`}
              >
